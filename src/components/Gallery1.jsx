//  url = http://www.omdbapi.com/?apikey=99ea514a&s=batman
...
class BatmanGallery extends Component {
  ...
  async componentDidMount() {
    await fetch("http://www.omdbapi.com/?apikey=99ea514a&s=batman")
    ...
    return (
      <>
        {this.state.film
          ...
          .map((film, index) => (
            <>
              <div className="my-2 mx-auto col-6 col-md-4 col-xl-2 gap-5 ">
